#-----------------------------------#
# TomRiddleBot | dbrown | 2014-09-03 #
#-----------------------------------#--------------------------
# Change log
# * 2014-09-03 :
#     (1.0.0)    - first code
...
__module_description__ = "%s by dbrown" % __module_name__
#
#--------------------------------------------------------------
# HEAD
#--------------------------------------------------------------
...
# HELP TEXT
#--------------------------------------------------------------
about = "%s version %s by dbrown for TomRiddle." % (__module_name__, __module_version__)
head_help = {
        "about": {
                "descr": [
                        "> !about",
...
# CONSTANTS
#--------------------------------------------------------------
admins = ["TomRiddle", "Buffy", "dbrown"]
sp_users = ["TomRiddle", "Buffy", "dbrown"]
...
sp_msg = {
        ...
        "emmawatson": {
                "words": '"I don''t believe her parents were muggles, because that ass is Magical!" – lie4karma',
        ...
        "bot": {
                "words": "TomRiddleBot V 1.6 built by dbrown and TomRiddle for Hexchat ",
